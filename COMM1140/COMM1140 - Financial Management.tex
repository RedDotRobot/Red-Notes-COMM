...
\section{Understanding Financial Statements}
	...
	\textbf{Learning Objectives}
		\begin{itemize}
			...
			\item Describe the relationship between the balance sheet and the income statement
				...
				\item The balance sheet has three main elements:
					\begin{itemize}
						...
						\item Shareholder's Equity (also known as Owner's Equity)
							\begin{itemize}
								\item What belongs to the owners, the "net assets" of the company (what would be left if all liabilities were paid for and all assets sold ($SE = A-L$))
								\item Consists of:
									\begin{itemize}
										\item Share capital
